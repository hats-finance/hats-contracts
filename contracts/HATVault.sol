    ...
    ReentrancyGuardUpgradeable
{
    ...
    ) external onlyRegistryOwner noActiveClaim {
    ...
    function maxWithdraw(
        ...
        returns (uint256)
    {
        if (activeClaim.createdAt != 0 || !_isWithdrawEnabledForUser(owner))
            return 0;
    ...
    function _deposit(
        ...
        if (!committeeCheckedIn) revert CommitteeNotCheckedInYet();
